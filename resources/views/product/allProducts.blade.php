...
<h1 class="text-center">___All  Products  ___</h1>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{ $product->productCount}} </td>
                    ...
                    <td>
                        <a href="{{ route('allProductBasket',$product->id)}}" class="btn btn-outline-success"><i class="bi bi-patch-check"></i></a> 
                    </td>
                    <td>
                        <a href="{{ route('allProductAbort',$product->id)}}" class="btn btn-outline-danger"><i class="bi bi-patch-minus"></i></a>
                    </td>
            <td>
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                           <a href="{{ route('productUpdateAll',$product->id)}}"><button type="button" class="btn btn-primary">Update</button></a>
